...
import com.tikal.cacao.sat.cfd.catalogos.C_Impuesto;
...
import com.tikal.cacao.sat.cfd.catalogos.C_TasaOCuota;
import com.tikal.cacao.sat.cfd.catalogos.C_TipoDeComprobante;
import com.tikal.cacao.sat.cfd.catalogos.C_TipoFactor;
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="Complemento" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class Comprobante {
    ...
    protected List<Comprobante.Complemento> complemento = new Vector<Comprobante.Complemento>();
    ...
    protected C_FormaPago formaPago;
    ...
    public List<Comprobante.Complemento> getComplemento() {
        if (complemento == null) {
            complemento = new Vector<Comprobante.Complemento>();
        }
     ...
     *     
     */
    public void setFormaPago(C_FormaPago value) {
     ...
     *     
     */
    public void setMoneda(C_Moneda value) {
        this.moneda = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link C_TipoDeComprobante }
     *     
     */
    public C_TipoDeComprobante getTipoDeComprobante() {
     ...
     *     
     */
    public void setTipoDeComprobante(C_TipoDeComprobante value) {
     ...
     *     
     */
    public void setMetodoPago(C_MetodoPago value) {
     ...
     *     
     */
    public String getLugarExpedicion() {//change the return type
     ...
     *     
     */
    public void setLugarExpedicion(String value) {//change the parameter
    ...
    public static class CfdiRelacionados {
        ...
        protected List<Comprobante.CfdiRelacionados.CfdiRelacionado> cfdiRelacionado = new Vector<Comprobante.CfdiRelacionados.CfdiRelacionado>();
        @XmlAttribute(name = "TipoRelacion", required = true)
        protected C_TipoRelacion tipoRelacion;
        ...
        public List<Comprobante.CfdiRelacionados.CfdiRelacionado> getCfdiRelacionado() {
            if (cfdiRelacionado == null) {
                cfdiRelacionado = new Vector<Comprobante.CfdiRelacionados.CfdiRelacionado>();
            }
         ...
         *     
         */
        public void setTipoRelacion(C_TipoRelacion value) {
    ...
    public static class Conceptos {
        ...
        protected List<Comprobante.Conceptos.Concepto> concepto = new Vector<Comprobante.Conceptos.Concepto>();
        ...
        public List<Comprobante.Conceptos.Concepto> getConcepto() {
            if (concepto == null) {
                concepto = new Vector<Comprobante.Conceptos.Concepto>();
            }
        ...
        public static class Concepto {
            ...
            protected List<Comprobante.Conceptos.Concepto.InformacionAduanera> informacionAduanera = new Vector<Comprobante.Conceptos.Concepto.InformacionAduanera>();
            ...
            protected List<Comprobante.Conceptos.Concepto.Parte> parte = new Vector<Comprobante.Conceptos.Concepto.Parte>();
            ...
            protected C_ClaveUnidad claveUnidad;
            ...
            public List<Comprobante.Conceptos.Concepto.InformacionAduanera> getInformacionAduanera() {
                if (informacionAduanera == null) {
                    informacionAduanera = new Vector<Comprobante.Conceptos.Concepto.InformacionAduanera>();
                }
            ...
            public List<Comprobante.Conceptos.Concepto.Parte> getParte() {
                if (parte == null) {
                    parte = new Vector<Comprobante.Conceptos.Concepto.Parte>();
                }
                return this.parte;
            }
             ...
             *     
             */
            public void setClaveUnidad(C_ClaveUnidad value) {
            ...
            public static class Impuestos {
                ...
                public static class Retenciones {
                    ...
                    protected List<Comprobante.Conceptos.Concepto.Impuestos.Retenciones.Retencion> retencion = new Vector<Comprobante.Conceptos.Concepto.Impuestos.Retenciones.Retencion>();
                    ...
                    public List<Comprobante.Conceptos.Concepto.Impuestos.Retenciones.Retencion> getRetencion() {
                        if (retencion == null) {
                            retencion = new Vector<Comprobante.Conceptos.Concepto.Impuestos.Retenciones.Retencion>();
                        }
                ...
                public static class Traslados {
                    ...
                    protected List<Comprobante.Conceptos.Concepto.Impuestos.Traslados.Traslado> traslado = new Vector<Comprobante.Conceptos.Concepto.Impuestos.Traslados.Traslado>();
                    ...
                    public List<Comprobante.Conceptos.Concepto.Impuestos.Traslados.Traslado> getTraslado() {
                        if (traslado == null) {
                            traslado = new Vector<Comprobante.Conceptos.Concepto.Impuestos.Traslados.Traslado>();
                        }
                    ...
                    public static class Traslado {
                        ...
                        protected C_TasaOCuota tasaOCuota;
                         ...
                         *     
                         */
                        public C_TasaOCuota getTasaOCuota() {
                            return tasaOCuota;
                        }
                         ...
                         *     
                         */
                        public void setTasaOCuota(C_TasaOCuota value) {
                            this.tasaOCuota = value;
                        }
            ...
            public static class Parte {
                ...
                @XmlElement(name = "InformacionAduanera")
                protected List<Comprobante.Conceptos.Concepto.Parte.InformacionAduanera> informacionAduanera = new Vector<Comprobante.Conceptos.Concepto.Parte.InformacionAduanera>();
                @XmlAttribute(name = "ClaveProdServ", required = true)
                protected String claveProdServ;
                @XmlAttribute(name = "NoIdentificacion")
                protected String noIdentificacion;
                ...
                public List<Comprobante.Conceptos.Concepto.Parte.InformacionAduanera> getInformacionAduanera() {
                    if (informacionAduanera == null) {
                        informacionAduanera = new Vector<Comprobante.Conceptos.Concepto.Parte.InformacionAduanera>();
                    }
                    return this.informacionAduanera;
                }
    ...
    public static class Emisor {
        ...
        protected C_RegimenFiscal regimenFiscal;
         ...
         *     
         */
        public void setRegimenFiscal(C_RegimenFiscal value) {
    ...
    public static class Impuestos {
        ...
        public static class Retenciones {
            ...
            @XmlElement(name = "Retencion", required = true)
            protected List<Comprobante.Impuestos.Retenciones.Retencion> retencion = new Vector<Comprobante.Impuestos.Retenciones.Retencion>();
            ...
            public List<Comprobante.Impuestos.Retenciones.Retencion> getRetencion() {
                if (retencion == null) {
                    retencion = new Vector<Comprobante.Impuestos.Retenciones.Retencion>();
                }
                return this.retencion;
            }
        ...
        public static class Traslados {
            ...
            @XmlElement(name = "Traslado", required = true)
            protected List<Comprobante.Impuestos.Traslados.Traslado> traslado = new Vector<Comprobante.Impuestos.Traslados.Traslado>();
            ...
            public List<Comprobante.Impuestos.Traslados.Traslado> getTraslado() {
                if (traslado == null) {
                    traslado = new Vector<Comprobante.Impuestos.Traslados.Traslado>();
                }
                return this.traslado;
            }
    ...
    public static class Receptor {
         ...
         *     
         */
        public void setUsoCFDI(C_UsoCFDI value) {
            this.usoCFDI = value;
        }
